...
if($_POST)
{
	$to_email   	= "hamededini@gmail.com"; //Recipient email, Replace with own email here
	...
	if(strlen($user_name)<4){ // If length is less than 4 it will output JSON error.
		$output = json_encode(array('type'=>'error', 'text' => 'Text is too short or empty!'));
		die($output);
	}
	...
	$replymsg = "Thank you for your request.";
	$send_mail2 = mail($user_email, $replymsg, $headers2);
